...
--
-- Name: SHOPS; Type: TABLE; Schema: FF_SCHEMA; Owner: phani
--

CREATE TABLE "FF_SCHEMA"."SHOPS" (
    "ID" uuid NOT NULL,
    "SHOP_NAME" character varying(30) NOT NULL,
    "SHOP_CATEGORY" character varying(10) NOT NULL,
...
ALTER TABLE "FF_SCHEMA"."SHOPS" OWNER TO phani;
...
--
-- Name: SHOPS SHOPS_pkey; Type: CONSTRAINT; Schema: FF_SCHEMA; Owner: phani
--

ALTER TABLE ONLY "FF_SCHEMA"."SHOPS"
...
--
-- Name: fki_SHOPID; Type: INDEX; Schema: FF_SCHEMA; Owner: postgres
--

CREATE INDEX "fki_SHOPID" ON "FF_SCHEMA"."PRODUCTS" USING btree ("SHOP_ID");
...
--
-- Name: PRODUCTS SHOPID; Type: FK CONSTRAINT; Schema: FF_SCHEMA; Owner: postgres
--

ALTER TABLE ONLY "FF_SCHEMA"."PRODUCTS"
    ADD CONSTRAINT "SHOPID" FOREIGN KEY ("SHOP_ID") REFERENCES "FF_SCHEMA"."SHOPS"("ID");
